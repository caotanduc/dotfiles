...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Breadcrumb faces (harmonized with PyLight mode line)
   `(breadcrumb-face
     ((,class (:inherit shadow :foreground "#408090" :height 0.9))))

   `(breadcrumb-project-crumbs-face
     ((,class (:foreground "#007020" :weight bold :height 0.9))))  ;; same green as keywords

   `(breadcrumb-project-base-face
     ((,class (:foreground "#0e84b5" :weight bold :height 0.9))))  ;; folder blue

   `(breadcrumb-project-leaf-face
     ((,class (:foreground "#06287e" :weight bold :height 0.9))))  ;; filename blue

   `(breadcrumb-imenu-crumbs-face
     ((,class (:foreground "#007020" :height 0.9))))               ;; intermediate symbol

   `(breadcrumb-imenu-leaf-face
     ((,class (:foreground "#4070a0" :weight bold :height 0.9))))  ;; function name

   ;; Header line (breadcrumb bar) -- same tone as mode-line
   `(header-line
     ((,class (:background "#ddeebb"     ;; same hue as mode-line
			   :foreground "#000000"
   ...
   ;; Header line
   `(header-line ((,class (:background "#eef5dd"
				       :foreground "#000000"
				       :box (:line-width -1 :color "#ccd8b0")
				       :height 0.95))))
   ;; Pulse highlighting
   '(pulse-highlight-start-face ((t (:background "#FFAE02" :foreground "#ffffff"))))
